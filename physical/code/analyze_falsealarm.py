...
def main() -> int:
    ...
    if k:
        ...
        if bound > a.budget:
            ...
            A("")
            A("**It is also not an instruction to record more.** The fault-free "
              "arm was frozen at 101 sessions on 24 September 2026 "
              "(`09_PREREGISTRATION.md` §4), and PP-1 states in advance that "
              "this outcome is reported as **untested**, not as a pass. "
              "Extending the campaign is permitted, as an amendment under §9 "
              "written *before* any further analysis — never as a reaction to "
