...
| 3 | **microSD card 32GB A2** (or U3) | $8–12 | The speed class matters: slower cards drop frames during recording, which is the failure that looks like data. |
...
| 14 | **USB flash drive, 128GB** | $10–15 | Recordings are ~25 MB each. A 30-hour campaign is roughly 9 GB. The SD card will fill first. |
